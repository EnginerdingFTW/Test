...
public class StartOptions : MonoBehaviour {
	...
	public GameObject mainMenu;											//The collection of UI Elements that make up the main menu
	public GameObject playMenu;											//The collection of UI Elements that make up the play menu
	...
	{
		playMenu.SetActive (true);   //show the play menu
		mainMenu.SetActive (false);  //remove the main menu
	}
